...
<body>
    <main class="translator-shell" data-translator-language="Orcish">
        <nav class="translator-nav" aria-label="Translator navigation">
            <a href="index.php">Choose translator</a>
            <a href="elven.php">Elven translator</a>
        </nav>
        <header>
        ...
        <form method="post" action="" class="translator-form">
            <label class="direction-toggle" for="orcish-to-english">
                <input id="orcish-to-english" name="orcish_to_english" type="checkbox" value="1" data-direction-toggle<?= $orcishToEnglish ? ' checked' : '' ?>>
