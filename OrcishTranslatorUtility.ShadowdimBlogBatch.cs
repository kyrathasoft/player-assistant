namespace PlayerAssistant
{
    ...
    {
        private const string ShadowdimBlogSourceCandidateData = """
adrenaline
agitated
airflow
amusement
...
""";
        ...
        private const string ShadowdimBlogNearKinCandidateData = """
...
cradles|cradle
cradling|cradle
crankshaft's|crankshaft
crankshafts|crankshaft
crawlspace's|crawlspace
crawlspaces|crawlspace
...
crisscrosses|crisscrossing
crystallize|crystallizes
crystallized|crystallizes
crystallizing|crystallizes
cushion's|cushions
cushion|cushions
cushioned|cushions
cushioning|cushions
...
slate's|slates
slate|slates
smolder's|smoldering
smolder|smoldering
smoldered|smoldering
smolders|smoldering
solvent's|solvent
solvents|solvent
spray|sprays
...
wedges|wedge
wedging|wedge
weightlessly|weightless
weightlessness|weightless
whetstone's|whetstone
...
""";
        ...
        private static IEnumerable<OrcishLexiconEntry> BuildShadowdimBlogCandidateEntries(
            IEnumerable<OrcishLexiconEntry> entries)
        {
            ...
            foreach (var english in ShadowdimBlogSourceCandidateData.Split(
                         ['\r', '\n'],
                         StringSplitOptions.RemoveEmptyEntries | StringSplitOptions.TrimEntries))
            {
                var root = $"vorn-{EncodeTwentyPageOrdinal(sourceOrdinal++)}";
                ...
                var candidate = new OrcishLexiconEntry(
                    ...
                    [
                        "blog",
                        "shadowdim-blog-candidate-batch",
                        "generated",
                        "review-promoted",
                        "close-form-reviewed",
                        $"family-{english}"
            ...
            foreach (var line in ShadowdimBlogNearKinCandidateData.Split(
                         ['\r', '\n'],
                         StringSplitOptions.RemoveEmptyEntries | StringSplitOptions.TrimEntries))
            {
