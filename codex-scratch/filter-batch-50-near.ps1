...
$data = Get-Content -Raw -LiteralPath 'codex-scratch\batch-50-near-raw.json' | ConvertFrom-Json
...
Set-Content -LiteralPath 'codex-scratch\batch-50-near-candidates.txt' -Value $candidateLines
Set-Content -LiteralPath 'codex-scratch\batch-50-near-families.txt' -Value $familyLines
