...
- **When the potions effect ends:** Affected animals will move away.

## Control Dragon

- **Affects:** 1â€3 dragons of a specific type. (The referee should determine which type of dragon the potion affects.)
- **Spell casting:** It is impossible to command a dragon to cast spells.
- **When the potions effect ends:** Affected dragons have a hostile reaction.

## Control Giant

- **Affects:** 1â€4 giants of a specific type. (The referee should determine which type of giant the potion affects.)
...
- **Charmed individuals:** Regard the character as a trusted friend and will come to their defense. They will obey the characters commands as long as these are not obviously harmful and do not contradict the subjects alignment.
...
- **When the potions effect ends:** Affected undead have a hostile reaction.
