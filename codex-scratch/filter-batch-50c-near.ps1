...
$data = Get-Content -Raw -LiteralPath 'codex-scratch\batch-50c-near-raw.json' | ConvertFrom-Json
...
Set-Content -LiteralPath 'codex-scratch\batch-50c-near-candidates.txt' -Value $candidateLines
Set-Content -LiteralPath 'codex-scratch\batch-50c-near-families.txt' -Value $familyLines
