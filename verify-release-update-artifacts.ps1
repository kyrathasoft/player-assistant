param(
    [string]$PublishArchivePath = (Join-Path $PSScriptRoot 'Release\installer\p-assist-0.9.1.zip'),
    [string]$InstallerPath = (Join-Path $PSScriptRoot 'Release\installer\p-assist-0.9.1.exe'),
