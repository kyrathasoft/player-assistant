...
const currentDataCache = 'player-assistant-pwa-0.9.8-v93-data';
const currentShellCache = 'player-assistant-pwa-0.9.8-v93-shell';
...
const testQuotaFailureReturnsNetworkResponse = async () => {
    const request = new Request('https://example.test/scarlethorizons/pwa/app.js?v=76');
...
const testObsoleteWorkerCannotDeleteNewerCaches = async () => {
    const newerShell = 'player-assistant-pwa-0.9.8-v94-shell';
    const newerData = 'player-assistant-pwa-0.9.8-v94-data';
    const harness = createHarness({
        cacheEntries: {
            [newerShell]: [],
            [newerData]: []
