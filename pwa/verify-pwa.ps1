...
Assert-Condition -Condition ($appScript.Contains('xpToNextLevel') -and $appScript.Contains('character.character_name} - ${tnlLabel}') -and $appScript.Contains('xp_to_next_level')) -Message 'XP Awards character headings must include the current TNL when available.'
