...
Assert-Condition -Condition ($html.Contains('href="styles.css?v=38"') -and $html.Contains('src="app.js?v=43"') -and $serviceWorker.Contains("player-assistant-pwa-0.9.8-v49") -and $serviceWorker.Contains("'./styles.css?v=38'") -and $serviceWorker.Contains("'./app.js?v=43'") -and $serviceWorker.Contains("'./level-progression.json'") -and $serviceWorker.Contains("'./magic-items.json'")) -Message 'The PWA shell must use cache-busting assets and preload the progression and magic-item data.'
