...
Assert-Condition -Condition ($html.Contains('href="styles.css?v=28"') -and $html.Contains('src="app.js?v=28"') -and $serviceWorker.Contains("'./styles.css?v=28'") -and $serviceWorker.Contains("'./app.js?v=28'")) -Message 'The PWA shell must use cache-busting stylesheet and application-script URLs.'
