...
Assert-Condition -Condition ($appScript.Contains('XP_AWARDS_PLAYER_GROUPS') -and $appScript.Contains('XP/index.json') -and $appScript.Contains('canViewXpAwards') -and $appScript.Contains('renderXpAwardsUi') -and $appScript.Contains('validateXpAwardsEntries')) -Message 'XP Awards loading and character access rules are incomplete.'
Assert-Condition -Condition ($appScript.Contains("maximilian: Object.freeze(['maximilian-xp.json', 'corba-xp.json'])")) -Message 'Maximilian must see Corba''s XP progression.'
...
Assert-Condition -Condition ($html.Contains('styles.css?v=43') -and $html.Contains('src="app.js?v=58"') -and $serviceWorker.Contains("player-assistant-pwa-0.9.8-v69") -and $serviceWorker.Contains("'./styles.css?v=43'") -and $serviceWorker.Contains("'./app.js?v=58'") -and $serviceWorker.Contains("'./level-progression.json'") -and $serviceWorker.Contains("'./magic-items.json'")) -Message 'The PWA shell must use cache-busting assets and preload the progression and magic-item data.'
