...
Assert-Condition -Condition ($html.Contains('href="styles.css?v=35"') -and $html.Contains('src="app.js?v=36"') -and $serviceWorker.Contains("'./styles.css?v=35'") -and $serviceWorker.Contains("'./app.js?v=36'") -and $serviceWorker.Contains("'./magic-items.json'")) -Message 'The PWA shell must use cache-busting assets and preload the magic-item fallback.'
